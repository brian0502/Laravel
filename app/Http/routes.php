...
Route::group(['prefix' => 'home'], function () {
    ...
    Route::get('add_note', 'HomeController@addNote');
    //Route::get('{title}/{message}', 'HomeController@show');
    Route::post('do_signup', 'HomeController@doSignup'); //若有form表單時使用
    Route::post('do_login', 'HomeController@doLogin'); //若有form表單時使用
    Route::post('do_add_note', 'HomeController@doAddNote'); //若有form表單時使用
